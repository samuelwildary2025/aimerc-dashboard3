  ...
  const openModal = (supermarket = null) => {
    if (supermarket) {
      ...
      setFormData({
        ...
        whatsapp_instance_token: supermarket.whatsapp_instance_token || ''
      })
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <span className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${supermarket.ativo
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2">
                    <label className="label">Token da Instância WhatsApp (Opcional)</label>
                    <input
                      className="input w-full font-mono text-sm"
                      name="whatsapp_instance_token"
                      value={formData.whatsapp_instance_token}
                      onChange={handleChange}
                      placeholder="Ex: 4fda8e12-0b9c-4456-a512..."
                    />
                    <p className="text-xs text-dark-400 mt-1">
                      Token usado para notificações automáticas via WhatsApp.
                    </p>
                  </div>
